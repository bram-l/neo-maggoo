 ...
 * @property {Object.<String, Node>} [models] - The models the results should be mapped to, where the key refer to the variable name and the value to Node model.
 * @property {String} [orderBy] - The ORDER BY parameter
 * @property {String} [return] - The RETURN parameter
 * @property {Number} [skip] - The number or records to skip
 * @property {Boolean} [singular] - Whether or not the query should return a singular result (defaults to false)
 * @property {String} [index] - Optional label index to be used for the query
 */
...
class Node extends Model
{
	 ...
	 * @param {QueryOptions} [o={}] Query options
	 * @returns {NodeCollection|Node} Results
	 *
	 * @example
